    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="text-center space-y-2">
                <h2 className="text-3xl font-black text-primary">法人税法上の時価 (Step 7/8)</h2>
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <div className="mt-4 text-center">
                            ...
                            <p className="text-sm text-foreground">
                                {results.comparisonDetails.length > 0 ? results.comparisonDetails[0].name : ""}
                            </p>
                        </div>
                    </div>
                </Card>
                        ...
                        {(() => {
                            ...
                            if (financials.isZeroElementCompany) {
                                return (
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-muted-foreground">純資産価額（土地は時価＋法人税控除しない）</p>
                                ...
                                return (
                                    <div className="space-y-2">
                                        ...
                                        <div className="pl-4 space-y-1">
                                            ...
                                            <p className="text-muted-foreground mt-2">ロ　純資産価額（土地は時価＋法人税控除しない）</p>
                            ...
                            return (
                                <div className="space-y-2">
                                    ...
                                    <p className="text-muted-foreground">次のうちいずれか低い方の金額</p>
                                    <div className="pl-4 space-y-1">
                                        <p className="text-muted-foreground">イ　純資産価額（土地は時価＋法人税控除しない）</p>
                                        <p className="text-foreground pl-6">{N.toLocaleString()}円</p>
