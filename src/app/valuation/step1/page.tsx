...
export default function Step1Page() {
    ...
    const [defaultValues, setDefaultValues] = useState<Partial<BasicInfo> | null>(null);
    ...
    const handleNext = (data: Partial<BasicInfo>, dummyDataKey?: DummyDataPatternKey) => {
        ...
        if (dummyDataKey) {
            ...
            const financials: Partial<Financials> = {
                ...
                industryStockPrice2MonthsBefore: pattern.industryStockPrice2MonthsBefore,
                industryStockPricePrevYearAverage: pattern.industryStockPricePrevYearAverage,
                industryDividends: pattern.industryDividendsYen + (pattern.industryDividendsSen * 0.1),
        ...
        sessionStorage.setItem("valuationBasicInfo", JSON.stringify(basicInfoToSave));
